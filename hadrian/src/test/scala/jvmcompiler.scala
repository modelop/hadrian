...
""", multiplicity = 2) map {_.asInstanceOf[PFAFoldEngine[AnyRef, AnyRef]]}
  ...
  "JVM expression compilation" must "do simple literals" taggedAs(JVMCompilation) in {
    ...
    an [PFASyntaxException] should be thrownBy { compileExpression("""{"int": "string"}""", """"int"""") }
    an [PFASyntaxException] should be thrownBy { compileExpression("""{"float": "string"}""", """"float"""") }
...
""", """"string"""").apply should be ("hello")
    ...
    an [PFASemanticException] should be thrownBy { compileExpression("""
do:
  - x
  - let: {x: [hello]}
""", """"null"""") }
...
""", """"int"""").apply }
  ...
  it must "call functions" taggedAs(JVMCompilation) in {
    ...
    an [PFASemanticException] should be thrownBy { compileExpression("""+: [2, [hello]]""", """"int"""") }
...
""", """"int"""") }
  ...
  it must "do if expressions" taggedAs(JVMCompilation) in {
    ...
    an [PFASemanticException] should be thrownBy { compileExpression("""{if: [hello], then: [3]}""", """"string"""") }
...
""").head
    ...
    engine.action(Array[Byte](4, 5, 6)).asInstanceOf[Array[Byte]].toList should be (List[Byte](1, 2, 3, 4, 5, 6))
    engine.action(Array[Byte](7, 8, 9)).asInstanceOf[Array[Byte]].toList should be (List[Byte](1, 2, 3, 4, 5, 6, 7, 8, 9))
    an [PFARuntimeException] should be thrownBy { engine.action(Array[Byte](0, 0)) }
  }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte]()) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](1, 2)) }
  }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](1)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](1, 2, 3)) }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](1, 2, 3)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](1, 2, 3, 4, 5)) }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](1, 2, 3, 4, 5, 6, 7)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](1, 2, 3, 4, 5, 6, 7, 8, 9)) }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](1, 2, 3, 4)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](1, 2, 3, 4, 5, 6)) }
  }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](104, 101, 108, 108, 111)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte]()) }
  }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](5, 104, 101, 108, 108, 111, 99)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](5, 104, 101, 108, 108)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte]()) }
  }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](99, 104, 101, 108, 108, 111, 0, 0, 0, 4, 1)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](99, 104, 101, 108, 108, 111, 0, 0, 0)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte]()) }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engineLittleEndian.action(Array[Byte](0, 0, 0, 4, 104, 101, 108, 108, 111, 0, 0, 0, 4, 1)) }
    an [PFAUserException] should be thrownBy { engineLittleEndian.action(Array[Byte](0, 0, 0, 4, 104, 101, 108, 108, 111, 0, 0, 0)) }
    an [PFAUserException] should be thrownBy { engineLittleEndian.action(Array[Byte]()) }
  }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](99, 104, 101, 108, 108, 111, 0, 0, 0, 0, 4, 1)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](99, 104, 101, 108, 108, 111, 0, 0, 0, 0)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte]()) }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engineLittleEndian.action(Array[Byte](0, 0, 0, 4, 104, 101, 108, 108, 111, 0, 0, 0, 0, 4, 1)) }
    an [PFAUserException] should be thrownBy { engineLittleEndian.action(Array[Byte](0, 0, 0, 4, 104, 101, 108, 108, 111, 0, 0, 0, 0)) }
    an [PFAUserException] should be thrownBy { engineLittleEndian.action(Array[Byte]()) }
  }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](99, 5, 104, 101, 108, 108, 111, 0, 0, 0, 4, 1)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte](99, 5, 104, 101, 108, 108, 111, 0, 0, 0)) }
    an [PFAUserException] should be thrownBy { engine.action(Array[Byte]()) }
...
""").head
    ...
    an [PFAUserException] should be thrownBy { engineLittleEndian.action(Array[Byte](0, 0, 0, 4, 5, 104, 101, 108, 108, 111, 0, 0, 0, 4, 1)) }
    an [PFAUserException] should be thrownBy { engineLittleEndian.action(Array[Byte](0, 0, 0, 4, 5, 104, 101, 108, 108, 111, 0, 0, 0)) }
    an [PFAUserException] should be thrownBy { engineLittleEndian.action(Array[Byte]()) }
  }
...
""", """["null", "int"]""").apply should be (null.asInstanceOf[java.lang.Void])
  ...
  it must "do error" taggedAs(JVMCompilation) in {
    an [PFAUserException] should be thrownBy { compileExpression("""{error: "This is bad"}""", """"null"""").apply }
    ...
    an [PFAUserException] should be thrownBy { compileExpression("""
if: true
then:
  - {error: "This is bad"}
""", """"null"""").apply }
...
""").head.action(null) should be ("hello")
    ...
    an [PFAUserException] should be thrownBy { PFAEngine.fromYaml("""
input: "null"
output: "null"
action:
  if: true
...
""").head
  ...
  it must "not accept bad indexes" taggedAs(JVMCompilation) in {
    an [PFARuntimeException] should be thrownBy {
      val engine = PFAEngine.fromYaml("""
input: {type: record, name: SimpleRecord, fields: [{name: one, type: {type: array, items: {type: map, values: int}}}]}
output: int
action:
...
""").head
  ...
  it must "not accept bad index types" taggedAs(JVMCompilation) in {
    an [PFASemanticException] should be thrownBy {
      val engine = PFAEngine.fromYaml("""
input: {type: record, name: SimpleRecord, fields: [{name: one, type: {type: array, items: {type: map, values: int}}}]}
output: int
action:
...
""").head.action("hey") } 
  ...
  "unshared pools" must "handle null cases" taggedAs(JVMCompilation) in {
    an [PFASyntaxException] should be thrownBy { PFAEngine.fromYaml("""
input: string
output: string
action:
  - {pool: notempty, path: []}
...
""").head
    ...
    an [PFARuntimeException] should be thrownBy { engine.action("whatever") }
  }
...
""").head
  ...
  "execution clock" must "stop int-running processes" taggedAs(JVMCompilation) in {
    an [PFATimeoutException] should be thrownBy { PFAEngine.fromYaml("""
input: string
output: "null"
action:
  - for: {x: 0}
...
""").head
    ...
    an [PFAInitializationException] should be thrownBy { PFAEngine.fromYaml("""
input: string
output: string
action:
  - input
...
""").head
    ...
    engine.action(java.lang.Integer.valueOf(2)) should be (java.lang.Integer.valueOf(2))
    engine.action(java.lang.Integer.valueOf(3)) should be (null)
    an [PFAUserException] should be thrownBy { engine.action(java.lang.Integer.valueOf(4)) }
    engine.action(java.lang.Integer.valueOf(5)) should be (java.lang.Integer.valueOf(5))
  }
...
""").head
    ...
    an [java.lang.ClassCastException] should be thrownBy { engine2.action(out1) }
