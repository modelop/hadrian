...
class LibCoreSuite extends FlatSpec with Matchers {
  "four-function calculator" must "do addition" taggedAs(Lib, LibCore) in {
    PFAEngine.fromYaml("""
input: double
output: double
action:
...
""").head.action(java.lang.Double.valueOf(3.14)) should be (6.28)
  ...
  it must "handle addition int overflows" taggedAs(Lib, LibCore) in {
...
""").head
    ...
    intercept[PFARuntimeException] { engine.action(java.lang.Integer.valueOf(2147483638)) }
...
""").head
    ...
    intercept[PFARuntimeException] { engine2.action(java.lang.Integer.valueOf(-2147483639)) }
  }
...
""").head
    ...
    intercept[PFARuntimeException] { engine.action(java.lang.Long.valueOf(9223372036854775798L)) }
...
""").head
    ...
    intercept[PFARuntimeException] { engine2.action(java.lang.Long.valueOf(-9223372036854775799L)) }
  }
...
""").head.action(java.lang.Double.valueOf(3.14)) should be (-2.04)
  ...
  it must "handle subtraction int overflows" taggedAs(Lib, LibCore) in {
    val engine = PFAEngine.fromYaml("""
input: int
output: int
action:
...
""").head
    ...
    intercept[PFARuntimeException] { engine.action(java.lang.Integer.valueOf(2147483639)) }
...
""").head
    ...
    intercept[PFARuntimeException] { engine2.action(java.lang.Integer.valueOf(-2147483638)) }
  }
...
""").head
    ...
    intercept[PFARuntimeException] { engine.action(java.lang.Long.valueOf(9223372036854775799L)) }
...
""").head
    ...
    intercept[PFARuntimeException] { engine2.action(java.lang.Long.valueOf(-9223372036854775798L)) }
  }
...
""").head
    ...
    intercept[PFARuntimeException] { engine.action(java.lang.Integer.valueOf(-2147483648)) }
  }
...
""").head
    ...
    intercept[PFARuntimeException] { engine.action(java.lang.Long.valueOf(-9223372036854775808L)) }
  }
...
""").head.action(java.lang.Double.valueOf(3.14)).asInstanceOf[Double] should be (30.96 +- 0.01)
  ...
  it must "handle multiplication int overflows" taggedAs(Lib, LibCore) in {
    val engine = PFAEngine.fromYaml("""
input: int
output: int
action:
...
""").head
    ...
    intercept[PFARuntimeException] { engine.action(java.lang.Integer.valueOf(1073741824)) }
  }
...
""").head
    ...
    intercept[PFARuntimeException] { engine.action(java.lang.Long.valueOf(4611686018427387904L)) }
    engine.action(java.lang.Long.valueOf(-4611686018427387904L)) should be (-9223372036854775808L)
    intercept[PFARuntimeException] { engine.action(java.lang.Long.valueOf(-4611686018427387905L)) }
  }
...
""").head.action(null) should be (1)
  ...
  it must "do negations with the right overflow handling" taggedAs(Lib, LibCore) in {
...
""").head
  ...
  it must "interpret %% as a division remainder (not a modulo operator)" taggedAs(Lib, LibCore) in {
    val engine1 = PFAEngine.fromYaml("""
input: int
output: int
action:
...
""").head
  ...
  it must "do exponentiation (pow or **)" taggedAs(Lib, LibCore) in {
    PFAEngine.fromYaml("""
input: double
output: double
action:
...
""").head.action(java.lang.Long.valueOf(3)) should be (205891132094649L)
  ...
  "comparison operators" must "do cmp" taggedAs(Lib, LibCore) in {
    val intEngine = PFAEngine.fromYaml("""
input: int
output: int
action:
...
""").head
  ...
  it must "do specific numerical operators" taggedAs(Lib, LibCore) in {
...
""").head
  ...
  it must "do specific non-numeric operators" taggedAs(Lib, LibCore) in {
    val LE = PFAEngine.fromYaml("""
input: string
output: boolean
action:
...
""").head
  ...
  it must "reject comparisons between different types, even if they have the same structure" taggedAs(Lib, LibCore) in {
    val engine = PFAEngine.fromYaml("""
...
""").head
  ...
  it must "do min" taggedAs(Lib, LibMath) in {
    val doubleEngine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
""").head
  ...
  "logical operators" must "work" taggedAs(Lib, LibCore) in {
...
""").head
  ...
  "bitwise operators" must "work" taggedAs(Lib, LibCore) in {
    PFAEngine.fromYaml("""
input: "null"
output: int
action:
...
""").head.action(null).asInstanceOf[Int] should be (-86)
  ...
  "Kleene operators" must "work" taggedAs(Lib, LibCore) in {
    val engine1 = PFAEngine.fromYaml("""
input:
  type: record
  name: Input
...
""").head
    ...
    engine1.action(engine1.jsonInput("""{"x": {"boolean": false}, "y": {"boolean": false}}""")) should be (java.lang.Boolean.FALSE)
    engine1.action(engine1.jsonInput("""{"x": {"boolean": false}, "y": null}""")) should be (java.lang.Boolean.FALSE)
    engine1.action(engine1.jsonInput("""{"x": {"boolean": false}, "y": {"boolean": true}}""")) should be (java.lang.Boolean.FALSE)

    engine1.action(engine1.jsonInput("""{"x": null, "y": {"boolean": false}}""")) should be (java.lang.Boolean.FALSE)
    engine1.action(engine1.jsonInput("""{"x": null, "y": null}""")) should be (null)
    engine1.action(engine1.jsonInput("""{"x": null, "y": {"boolean": true}}""")) should be (null)

    engine1.action(engine1.jsonInput("""{"x": {"boolean": true}, "y": {"boolean": false}}""")) should be (java.lang.Boolean.FALSE)
    engine1.action(engine1.jsonInput("""{"x": {"boolean": true}, "y": null}""")) should be (null)
    engine1.action(engine1.jsonInput("""{"x": {"boolean": true}, "y": {"boolean": true}}""")) should be (java.lang.Boolean.TRUE)
...
""").head
    ...
    engine2.action(engine2.jsonInput("""{"x": {"boolean": false}, "y": {"boolean": false}}""")) should be (java.lang.Boolean.FALSE)
    engine2.action(engine2.jsonInput("""{"x": {"boolean": false}, "y": null}""")) should be (null)
    engine2.action(engine2.jsonInput("""{"x": {"boolean": false}, "y": {"boolean": true}}""")) should be (java.lang.Boolean.TRUE)

    engine2.action(engine2.jsonInput("""{"x": null, "y": {"boolean": false}}""")) should be (null)
    engine2.action(engine2.jsonInput("""{"x": null, "y": null}""")) should be (null)
    engine2.action(engine2.jsonInput("""{"x": null, "y": {"boolean": true}}""")) should be (java.lang.Boolean.TRUE)

    engine2.action(engine2.jsonInput("""{"x": {"boolean": true}, "y": {"boolean": false}}""")) should be (java.lang.Boolean.TRUE)
    engine2.action(engine2.jsonInput("""{"x": {"boolean": true}, "y": null}""")) should be (java.lang.Boolean.TRUE)
    engine2.action(engine2.jsonInput("""{"x": {"boolean": true}, "y": {"boolean": true}}""")) should be (java.lang.Boolean.TRUE)
...
""").head
    ...
    engine3.action(engine3.jsonInput("""{"x": {"boolean": false}}""")) should be (java.lang.Boolean.TRUE)
    engine3.action(engine3.jsonInput("""{"x": null}""")) should be (null)
    engine3.action(engine3.jsonInput("""{"x": {"boolean": true}}""")) should be (java.lang.Boolean.FALSE)
  }
}
