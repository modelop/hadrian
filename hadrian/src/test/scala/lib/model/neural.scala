...
package test.scala.lib.model.neural
...
class LibModelNeuralSuite extends FlatSpec with Matchers {
  "model.neural.simpleLayered" must "do XOR problem" taggedAs(Lib, LibModelNeural) in {
