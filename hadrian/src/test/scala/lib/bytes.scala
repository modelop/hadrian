...
""").head
    ...
    an [PFARuntimeException] should be thrownBy { engine.action(Array[Byte](104, 101, 108, -127, 111)) }
  }
...
""").head
    ...
    an [PFARuntimeException] should be thrownBy { engine.action(new String(Array[Byte](104, 101, 108, -127, 111))) }
  }
