...
""").head
    ...
    an [PFARuntimeException] should be thrownBy { engine.action("   2147483648   ") }
    engine.action("   -2147483648   ") should be (-2147483648)
    an [PFARuntimeException] should be thrownBy { engine.action("   -2147483649   ") }
  }
...
""").head
    ...
    an [PFARuntimeException] should be thrownBy { engine.action("   9223372036854775808   ") } 
    engine.action("   -9223372036854775808   ") should be (-9223372036854775808L)
    an [PFARuntimeException] should be thrownBy { engine.action("   -9223372036854775809   ") }
  }
