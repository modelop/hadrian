...
class LibLASuite extends FlatSpec with Matchers {
  ...
  "linear algebra library" must "map arrays" taggedAs(Lib, LibLA) in {
...
""").head
  ...
  it must "map maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
...
""").head
  ...
  it must "scale arrays" taggedAs(Lib, LibLA) in {
...
""").head
  ...
  it must "scale maps" taggedAs(Lib, LibLA) in {
    val engine1 = PFAEngine.fromYaml("""
input: "null"
...
""").head
  ...
  it must "zipmap arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: array, items: {type: array, items: double}}
action:
...
""").head
  ...
  it must "zipmap maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: map, values: {type: map, values: double}}
action:
...
""").head
  ...
  it must "add arrays" taggedAs(Lib, LibLA) in {
    val engine1 = PFAEngine.fromYaml("""
input: "null"
output: {type: array, items: double}
action:
...
""").head
  ...
  it must "add maps" taggedAs(Lib, LibLA) in {
    val engine1 = PFAEngine.fromYaml("""
input: "null"
output: {type: map, values: double}
action:
...
""").head
  ...
  it must "subtract arrays" taggedAs(Lib, LibLA) in {
    val engine1 = PFAEngine.fromYaml("""
input: "null"
output: {type: array, items: double}
action:
...
""").head
  ...
  it must "subtract maps" taggedAs(Lib, LibLA) in {
    val engine1 = PFAEngine.fromYaml("""
input: "null"
output: {type: map, values: double}
action:
...
""").head
  ...
  it must "multiply a matrix and a vector as arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: array, items: double}
action:
...
""").head
  ...
  it must "multiply matrices as arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: array, items: {type: array, items: double}}
action:
...
""").head
  ...
  it must "multiply a matrix and a vector as maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: map, values: double}
action:
...
""").head
  ...
  it must "multiply matrices as maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: map, values: {type: map, values: double}}
action:
...
""").head
  ...
  it must "transpose arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: array, items: {type: array, items: double}}
action:
...
""").head
  ...
  it must "transpose maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: map, values: {type: map, values: double}}
action:
...
""").head
  ...
  it must "compute a (pseudo)inverse from arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: array, items: {type: array, items: double}}
action:
...
""").head
  ...
  it must "compute a (pseudo)inverse from maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: map, values: {type: map, values: double}}
action:
...
""").head
  ...
  it must "compute a trace from arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: double
action:
...
""").head
  ...
  it must "compute a trace from maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: double
action:
...
""").head
  ...
  it must "compute a determinant from arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: double
action:
...
""").head
  ...
  it must "compute a determinant from maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: double
action:
...
""").head
  ...
  it must "identify symmetric matrices as arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: boolean
action:
...
""").head
  ...
  it must "identify symmetric matrices as maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: boolean
action:
...
""").head
  ...
  it must "compute an eigenbasis from arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: array, items: {type: array, items: double}}
action:
...
""").head
  ...
  it must "compute an eigenbasis from maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: map, values: {type: map, values: double}}
action:
...
""").head
  ...
  it must "accumulate a covariance and compute eigenbasis using arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input:
  type: record
  name: Input
...
""").head
  ...
  it must "truncate a matrix using arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: array, items: {type: array, items: double}}
action:
...
""").head
  ...
  it must "truncate a matrix using maps" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
input: "null"
output: {type: map, values: {type: map, values: double}}
action:
...
""").head
  ...
  it must "accumulate a covariance and use that to update a PCA matrix using arrays" taggedAs(Lib, LibLA) in {
    val engine = PFAEngine.fromYaml("""
