...
package test.scala.lib.prob.dist
...
class LibProbDistSuite extends FlatSpec with Matchers {
  "normal distribution" must "have the right log likelihoods" taggedAs(Lib, LibProbDist) in {
...
// NORMAL CDF
  it must "have the right CDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
""").head
  ...
  it must "have the right QF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
""").head
  ...
  it must "be a delta function in right conditions" taggedAs(Lib, LibProbDist) in {
    val engine1 = PFAEngine.fromYaml("""
input: double
output: double
action:
...
""").head
  ...
  it must "raise the correct exceptions" taggedAs(Lib, LibProbDist) in {
    val engine1 = PFAEngine.fromYaml("""
input: double
output: double
action:
  - prob.dist.gaussianLL:
      ...
      - value: {count: 21, mean: 10, variance: -3.0}
        type: {type: record, name: Rec, namespace: what.ever, fields: [{name: count, type: double}, {name: mean, type: double}, {name: variance, type: double}]}
""").head
    an [PFARuntimeException] should be thrownBy { engine1.action(java.lang.Double.valueOf(3.0)) } 
...
""").head
    an [PFARuntimeException] should be thrownBy { engine2.action(java.lang.Double.valueOf(3.0)) } 
...
action:
  - prob.dist.gaussianCDF:
      ...
      - value: {count: 21, mean: 10, variance: -3.0}
        type: {type: record, name: Rec, namespace: what.ever, fields: [{name: count, type: double}, {name: mean, type: double}, {name: variance, type: double}]} 
""").head
    an [PFARuntimeException] should be thrownBy { engine3.action(java.lang.Double.valueOf(3.0)) } 
...
action:
  - prob.dist.gaussianQF:
      ...
      - value: {count: 21, mean: 10, variance: -3.0}
        type: {type: record, name: Rec, namespace: what.ever, fields: [{name: count, type: double}, {name: mean, type: double}, {name: variance, type: double}]} 
""").head
    an [PFARuntimeException] should be thrownBy { engine5.action(java.lang.Double.valueOf(3.0)) } 
...
""").head
    an [PFARuntimeException] should be thrownBy { engine6.action(java.lang.Double.valueOf(1.3)) } 
    an [PFARuntimeException] should be thrownBy { engine6.action(java.lang.Double.valueOf(-0.3)) } 
    }


/////////////////EXPONENTIAL DISTRIBUTION TESTS
  "exponential distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
""").head
  ...
  it must "have correct behavior handling edge cases" taggedAs(Lib, LibProbDist) in {
    val engine1 = PFAEngine.fromYaml("""
input: double
output: double
action:
...
action:
  - prob.dist.exponentialQF: [input, -1]
""").head
    an [PFARuntimeException] should be thrownBy { engine3.action(java.lang.Double.valueOf(0.4)) } 
...
""").head
    an [PFARuntimeException] should be thrownBy { engine4.action(java.lang.Double.valueOf(-1.4)) } 
    an [PFARuntimeException] should be thrownBy { engine4.action(java.lang.Double.valueOf(1.4)) } 
    }

///////////// POISSON DISTRIBUTION TESTS /////////////////
  "poisson distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: int
output: double
action:
...
""").head
    ...
    engine.action(java.lang.Integer.valueOf(0)).asInstanceOf[java.lang.Double].doubleValue should be    (0.0183 +- 0.001)
    engine.action(java.lang.Integer.valueOf(2)).asInstanceOf[java.lang.Double].doubleValue should be    (0.2381 +- 0.001)
    engine.action(java.lang.Integer.valueOf(10)).asInstanceOf[java.lang.Double].doubleValue should be   (0.9972 +- 0.001)
    engine.action(java.lang.Integer.valueOf(-10)).asInstanceOf[java.lang.Double].doubleValue should be  (0.0 +- 0.001)
    }
...
""").head
  ...
  it must "handle edge cases properly" taggedAs(Lib, LibProbDist) in {
    val engine1 = PFAEngine.fromYaml("""
input: int
output: double
action:
...
""").head
    ...
    engine2.action(java.lang.Integer.valueOf(0)).asInstanceOf[java.lang.Double].doubleValue should be  (1.0)
...
action:
  - prob.dist.poissonPDF: [input, -4] #[input, lambda]
""").head
    an [PFARuntimeException] should be thrownBy { engine1.action(java.lang.Integer.valueOf(4)) } 
...
""").head
    an [PFARuntimeException] should be thrownBy { engine2.action(java.lang.Integer.valueOf(4)) } 
...
action:
  - prob.dist.poissonQF: [input, 2] #[input, lambda]
""").head
    an [PFARuntimeException] should be thrownBy { engine4.action(java.lang.Double.valueOf(-0.4)) } 
    an [PFARuntimeException] should be thrownBy { engine4.action(java.lang.Double.valueOf(1.4)) } 
    }


///////////////////////////////// CHI2 DISTRIBUTION /////////////////////////////////////
  "chi2 distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
""").head
    an [PFARuntimeException] should be thrownBy { engine5.action(java.lang.Double.valueOf(0.4)) } 
...
""").head
    an [PFARuntimeException] should be thrownBy { engine6.action(java.lang.Double.valueOf(0.4)) } 
...
""").head
    an [PFARuntimeException] should be thrownBy { engine3.action(java.lang.Double.valueOf(-0.4)) } 
    an [PFARuntimeException] should be thrownBy { engine3.action(java.lang.Double.valueOf(1.4)) } 
    }
...
// NOTE: R's df with df1 = 1, and df2 = * and x = 0 incorrectly produces Inf, this version does not.
  "F distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
""").head
    an [PFARuntimeException] should be thrownBy { engine1.action(java.lang.Double.valueOf(0.4)) } 
...
""").head
    an [PFARuntimeException] should be thrownBy { engine2.action(java.lang.Double.valueOf(0.4)) } 
...
//////////////////////// GAMMA-DISTRIBUTION
  "Gamma distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
//////////////////////// BETA-DISTRIBUTION
  "beta distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
//////////////////////// CAUCHY-DISTRIBUTION
  "cauchy distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
//////////////////////// LOGNORMAL-DISTRIBUTION
  "lognormal distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
//////////////////////// STUDENTT-DISTRIBUTION
  "studentt distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
///////////// BINOMIAL DISTRIBUTION TESTS /////////////////
  "binomial distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: int
output: double
action:
...
""").head
    an [PFARuntimeException] should be thrownBy { engine1.action(java.lang.Integer.valueOf(5)) } 
...
""").head
    an [PFARuntimeException] should be thrownBy { engine2.action(java.lang.Double.valueOf(4.0)) } 
...
//////////////////////// UNIFORM-DISTRIBUTION
  "uniform distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
""").head
    an [PFARuntimeException] should be thrownBy { engine2.action(java.lang.Double.valueOf(2.4)) } 
...
///////////// GEOMETRIC DISTRIBUTION TESTS /////////////////
  "geometric distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: int
output: double
action:
...
///////////// HYPERGEOMETRIC DISTRIBUTION TESTS /////////////////
  "hypergeometric distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: int
output: double
action:
...
""").head
    an [PFARuntimeException] should be thrownBy { engine1.action(java.lang.Integer.valueOf(3)) } 
...
///////////// NEGATIVE-BINOMIAL DISTRIBUTION TESTS /////////////////
  "negativeBinomial distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: int
output: double
action:
...
//////////////////////// WEIBULL-DISTRIBUTION
  "weibull distribution" must "have the right PDF" taggedAs(Lib, LibProbDist) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
action:
  - prob.dist.weibullPDF: [input, -2, 4] #[input, shape, scale]
""").head
    an [PFARuntimeException] should be thrownBy { engine1.action(java.lang.Double.valueOf(1.4)) } 
...
""").head
    an [PFARuntimeException] should be thrownBy { engine2.action(java.lang.Double.valueOf(1.4)) } 
