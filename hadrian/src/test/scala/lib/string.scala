...
""").head
    ...
    an [PFARuntimeException] should be thrownBy { engine1.action(java.lang.Integer.valueOf(-1)) } 
...
""").head
    ...
    an [PFARuntimeException] should be thrownBy { engine2.action(java.lang.Integer.valueOf(-1)) } 
...
""").head
    ...
    an [PFARuntimeException] should be thrownBy { engine2a.action(java.lang.Integer.valueOf(-1)) } 
...
""").head
    ...
    an [PFARuntimeException] should be thrownBy { engine3.action(java.lang.Integer.valueOf(-1)) } 
  }
