...
class Lib1SpecSuite extends FlatSpec with Matchers {
"log beta function" must "evaluate correctly" taggedAs(Lib1, Lib1Spec) in {
...
""").head
  ...
  it must "raise the correct exceptions" taggedAs(Lib1, Lib1Spec) in {
...
"n choose k" must "evaluate correctly" taggedAs(Lib1, Lib1Spec) in {
    val engine = PFAEngine.fromYaml("""
input: int
output: int
action:
...
"erf" must "evaluate correctly" taggedAs(Lib1, Lib1Spec) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
"erfc" must "evaluate correctly" taggedAs(Lib1, Lib1Spec) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
"lnGamma" must "evaluate correctly" taggedAs(Lib1, Lib1Spec) in {
    val engine = PFAEngine.fromYaml("""
input: double
output: double
action:
...
//"regularized gamma P function" must "evaluate correctly" taggedAs(Lib1, Lib1Spec) in {
//    val engine = PFAEngine.fromYaml("""
//input: double
//output: double
//action:
...
//    }
//
//"regularized gamma Q function" must "evaluate correctly" taggedAs(Lib1, Lib1Spec) in {
//    val engine = PFAEngine.fromYaml("""
//input: double
//output: double
//action:
