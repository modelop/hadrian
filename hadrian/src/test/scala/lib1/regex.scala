...
class Lib1RegexSuite extends FlatSpec with Matchers {

  "the regex engine" must "not be leaking memory" taggedAs(Lib1, Lib1Regex) in {
...
""").head
  ...
  "index" must "be very Posix extended" taggedAs(Lib1, Lib1Regex) in {
...
""").head
  ...
  "index" must "return correct index" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: {type: array, items: int}
action:
...
""").head
  ...
  "contains" must "check if match exists" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: boolean
action:
...
""").head
  ...
  "count" must "count occurances" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: int
action:
...
""").head
  ...
  "rIndex" must "find indices of the last match" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: {type: array, items: int}
action:
...
""").head
  ...
  "groups" must "show which groups matched where" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
...
""").head
  ...
  "indexAll" must "must return indices of where patterns longest group matched" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: {type: array, items: {type: array, items: int}}
action:
...
""").head
  ...
  "findAll" must "must return strings from where patterns longest group matched" taggedAs(Lib1, Lib1Regex) in {
...
""").head
  ...
  "findFirst" must "must return first substring of match" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: [string, "null"]
action:
...
""").head
  ...
  "findGroupsFirst" must "must return strings of the longest group match" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: {type: array, items: string}
action:
...
""").head
  ...
  "findGroupsAll" must "must return substrings of each group match in each location" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
...
""").head
  ...
  "groupsAll" must "must return all group indices of all matches" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
...
""").head
  ...
  "replaceFirst" must "replace first occurance" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: string
action:
...
""").head
  ...
  "replaceLast" must "replace last instance" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: string
action:
...
""").head
  ...
  "replaceAll" must "make replacements correctly" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: string
action:
...
""").head
  ...
  "split" must "split on the pattern" taggedAs(Lib1, Lib1Regex) in {
    val engine = PFAEngine.fromYaml("""
input: string
output: {type: array, items: string}
action:
