...
class Lib1LinkSuite extends FlatSpec with Matchers {
  "m.link.*" must "softmax" taggedAs(Lib1, Lib1Link) in {
...
""").head
  ...
  it must "logit" taggedAs(Lib1, Lib1Link) in {
...
""").head
  ...
  it must "probit" taggedAs(Lib1, Lib1Link) in {
    val engine1 = PFAEngine.fromYaml("""
input: double
output: double
...
""").head
  ...
  it must "cloglog" taggedAs(Lib1, Lib1Link) in {
    val engine1 = PFAEngine.fromYaml("""
input: double
output: double
...
""").head
  ...
  it must "loglog" taggedAs(Lib1, Lib1Link) in {
    val engine1 = PFAEngine.fromYaml("""
input: double
output: double
...
""").head
  ...
  it must "cauchit" taggedAs(Lib1, Lib1Link) in {
    val engine1 = PFAEngine.fromYaml("""
input: double
output: double
...
""").head
  ...
  it must "softplus" taggedAs(Lib1, Lib1Link) in {
    val engine1 = PFAEngine.fromYaml("""
input: double
output: double
...
""").head
  ...
  it must "relu" taggedAs(Lib1, Lib1Link) in {
    val engine1 = PFAEngine.fromYaml("""
input: double
output: double
...
""").head
  ...
  it must "tanh" taggedAs(Lib1, Lib1Link) in {
    val engine1 = PFAEngine.fromYaml("""
input: double
output: double
