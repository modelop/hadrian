...
package object sample {
  ...
  ////   topN (TopN)
  object TopN extends LibFcn {
    val name = prefix + "topN"
    val sig = Sig(List("x" -> P.Wildcard("A"), "top" -> P.Array(P.Wildcard("A")), "n" -> P.Int, "lessThan" -> P.Fcn(List(P.Wildcard("A"), P.Wildcard("A")), P.Boolean)), P.Array(P.Wildcard("A")))
    val doc = <doc>
