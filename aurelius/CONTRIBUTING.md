...
The goal of this guide is to help you contribute to aurelius as quickly and 
as easily possible. It is a verbatim copy of the contributing guidelines for 
the R package devtools (https://github.com/hadley/devtools/blob/master/CONTRIBUTING.md). 
...
1.  Check that you're using the latest version of aurelius. It's quite
...
*   If you can, also write a test. Testing aurelius is important to ensure that 
    users of the package are getting what they expect.
...
A pull request is a process, and unless you're a practiced contributor it's 
unlikely that your pull request will be accepted as is. Typically the process 
looks like this:
...
Don't worry if your pull request isn't perfect. It's a learning process and 
we'll be happy to help you out. 

It can be frustrating that your PR is ignored for months, and then we request 
a whole bunch on changes within a short time period. Don't worry - if your PR 
doesn't make it for this release, it will for the next one.
